...
int main(int argc, char** argv) {
	...
	ros::Subscriber scan_subscriber_ = nodeHandle.subscribe("scan", queue_size, &husky_highlevel_controller_new::HuskyHighlevelControllerNew::scanCallback, &huskyHighlevelControllerNew);
