...
HuskyHighlevelControllerEx4::HuskyHighlevelControllerEx4(ros::NodeHandle& nodeHandle) :
  nodeHandle_(nodeHandle) {
  	// to obtain the params by calling getParam()
  	nodeHandle.getParam("/husky_highlevel_controller_ex_4/scan_subscriber_topic", scan_subscriber_topic);
  	nodeHandle.getParam("/husky_highlevel_controller_ex_4/scan_subscriber_queue_size", scan_subscriber_queue_size);
  	nodeHandle.getParam("/husky_highlevel_controller_ex_4/cmd_pub_topic", cmd_pub_topic);
   	nodeHandle.getParam("/husky_highlevel_controller_ex_4/cmd_pub_queue_size", cmd_pub_queue_size);
   	nodeHandle.getParam("/husky_highlevel_controller_ex_4/visualization_pub_queue_size", visualization_pub_queue_size);
   	nodeHandle.getParam("/husky_highlevel_controller_ex_4/visualization_pub_topic", visualization_pub_topic);
   	nodeHandle.getParam("/husky_highlevel_controller_ex_4/red_value", red_value);
   	nodeHandle.getParam("/husky_highlevel_controller_ex_4/green_value", green_value);
   	nodeHandle.getParam("/husky_highlevel_controller_ex_4/blue_value", blue_value);
   	nodeHandle.getParam("/husky_highlevel_controller_ex_4/zPosPillar", zPosPillar);

 	
 	// definity need to advertise a publisher otherwise it didn't show up at the system
	scan_subscriber_ = nodeHandle_.subscribe(scan_subscriber_topic, scan_subscriber_queue_size, &HuskyHighlevelControllerEx4::scanCallback, this);
...
void HuskyHighlevelControllerEx4::scanCallback(const sensor_msgs::LaserScan &scan_msg) {
...
void HuskyHighlevelControllerEx4::pillar_visualization() {
...
HuskyHighlevelControllerEx4::~HuskyHighlevelControllerEx4() {}
